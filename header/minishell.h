...
int								handle_special_c(t_data *data, int *nbword,
									int *i);
int								handle_chevron(t_data *data, int *nbword,
									int *i);
int								handle_redirect(t_data *data, int *nbword,
									int *i, int c);
int								handle_quotes(t_data *data, int *nbword,
									int *i);
...
void							handle_simple_cmd(t_data *data, int start,
									int end);
void							handle_redir_cmd(t_data *data, int start,
									int end);
...
int								handle_special_c_new(t_data *data, char *old,
									t_new *new, int *i);
int								handle_redirect_new(char *old, t_new *new,
									int *i, int c);
